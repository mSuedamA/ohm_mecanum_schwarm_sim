...
#add
sim.spawn_robot(4.5, 4, 0, 1, "part1")
sim.spawn_robot(1.5, 4, 1*pi/2, 2, "part2")
sim.spawn_robot(7.5, 4, 1*pi/2, 3, "part3")
sim.spawn_robot(7.5, 2, 1*pi/2, 4, "part4")
sim.spawn_robot(10.5, 4, 1*pi/2, 5, "part5")
sim.spawn_robot(10.5, 2, 0, 6, "part6")
sim.spawn_robot(7.5, 7, 1*pi/2, 0, "part0")
