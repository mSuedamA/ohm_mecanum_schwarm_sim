...
# Date:        10.8.2021
# Description: Pygame-based robot swarm simulator application
# ------------------------------------------------------------

import pygame
import rospy
from ohm_robot_swarm_simulator import Ohm_Robot_Swarm_Simulator
from math import pi
...
sim = Ohm_Robot_Swarm_Simulator(surface, "ohm_schwarm_sim", "Ohm Robot Swarm Simulator")
